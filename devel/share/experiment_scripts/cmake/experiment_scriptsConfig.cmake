...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'experiment_scripts' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/romesc/WRK/weight_express/src/experiment_scripts/${idir}'.  Ask the maintainer 'Stefanos Nikolaidis <snikolai@andrew.cmu.edu>' to fix it.")
    endif()
